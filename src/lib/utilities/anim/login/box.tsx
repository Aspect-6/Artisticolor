...
module.exports = {
	...
	addListeners: () => {
		...
		document
			...
			.addEventListener('focus', module.exports.email)
		document
			.getElementById('email')
			.addEventListener('blur', module.exports.deselect)
		document
			.getElementById('password')
			.addEventListener('focus', module.exports.password)
		document
			.getElementById('password')
			.addEventListener('blur', module.exports.deselect)
		//Open/close login-box
		document
			.getElementById('lgnButton')
			.addEventListener('click', module.exports.open)
		document
			.getElementById('close')
			.addEventListener('click', module.exports.close)
	},
}
